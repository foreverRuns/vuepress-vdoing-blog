  ...
  <div class="home-wrapper">
    ...
    <MainLayout>
      ...
      <template #mainRight>
        ...
        <CategoriesBar v-if="homeData.category !== false && $themeConfig.category !== false && $categoriesAndTags.categories.length" :categoriesData="$categoriesAndTags.categories" :length="10" />
        <TagsBar v-if="homeData.tag !== false && $themeConfig.tag !== false && $categoriesAndTags.tags.length" :tagsData="$categoriesAndTags.tags" :length="30" />
