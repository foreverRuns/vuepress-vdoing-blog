    ...
    <div class="blogger" v-if="blogger">
      ...
      <div class="blogger-info">
        ...
        <div class="icons" v-if="blogger.social">
          <a :href="item.link" :title="item.title" :class="['iconfont', item.iconClass]" v-for="(item, index) in blogger.social.icons" :key="index" target="_blank"></a>
        </div>
...
import NavLinksBefore from './NavLinksBefore'
