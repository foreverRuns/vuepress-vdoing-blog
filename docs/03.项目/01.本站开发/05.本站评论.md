...
![githubApplication](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/githubApplication.3f33cxws5j9c.webp)
...
![githubClientSecrets](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/githubClientSecrets.4232rym2toqo.webp)
...
![gitalk](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/gitalk.67765yjvlcow.webp)

点击按钮去授权登录，然后就开启评论功能啦。

![gitalk1](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/gitalk1.6mku1bxw73b4.webp)
...
![lc](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/lc.6c94s1cq6jk0.webp)

进入刚才创建的应用，然后侧边栏中选择 `设置/应用凭证`，获取你的 AppID 和 AppKey

![lc1](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/lc1.60q3umo38dxc.webp)
...
1. 在全局样式文件 `docs/.vuepress/styles/index.styl` 中重置 Valine 评论模块的样式
...
![valine](https://cdn.jsdelivr.net/gh/foreverRuns/image-hosting@main/blog/valine.7ewizr5yt85c.webp)
